...
class _CompositeNumberInfoPageState extends State<CompositeNumberInfoPage> {
  ...
  void _onQuizPressed() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CompositeNumberPracticePage()),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberShowcase(
                      title: isEnglish
                          ? 'Composite number spotlight'
                          : 'Números compuestos destacados',
  ...
  Widget _buildNumberShowcase({
    ...
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF004D40).withOpacity(0.92),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(
