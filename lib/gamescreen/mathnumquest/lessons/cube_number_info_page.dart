...
class _CubeNumberInfoPageState extends State<CubeNumberInfoPage> {
  ...
  void _onQuizPressed() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CubesExamplePage()),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberShowcase(
                      title: isEnglish
                          ? 'Cube number spotlight'
                          : 'Números cúbicos destacados',
          ...
          Row(
            children: [
              const Icon(Icons.view_in_ar,
                  color: Color(0xFF006064), size: 30),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  title,
  ...
  Widget _buildNumberShowcase({
    ...
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF006064).withOpacity(0.92),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(
            color: Color(0x33006064),
            blurRadius: 18,
            offset: Offset(0, 12),
          ),
        ],
