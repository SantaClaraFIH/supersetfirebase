...
class _FibonacciNumberInfoPageState extends State<FibonacciNumberInfoPage> {
  ...
  void _onQuizPressed() {
    ...
    // No quiz page defined for Fibonacci numbers yet
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberShowcase(
                      title: isEnglish
                          ? 'Fibonacci number spotlight'
                          : 'Números Fibonacci destacados',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.eco, color: Color(0xFF1B5E20), size: 30),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  title,
  ...
  Widget _buildNumberShowcase({
    ...
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF1B5E20).withOpacity(0.92),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(
