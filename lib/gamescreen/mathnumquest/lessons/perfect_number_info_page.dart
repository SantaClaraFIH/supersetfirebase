...
class _PerfectNumberInfoPageState extends State<PerfectNumberInfoPage> {
  ...
  void _onQuizPressed() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PerfectNumberPracticePage()),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberShowcase(
                      title: isEnglish
                          ? 'Perfect number spotlight'
                          : 'Números perfectos destacados',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.stars, color: Color(0xFF880E4F), size: 30),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  title,
  ...
  Widget _buildNumberShowcase({
    ...
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF880E4F).withOpacity(0.92),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(
            color: Color(0x33880E4F),
            blurRadius: 18,
            offset: Offset(0, 12),
          ),
        ],
