...
class _PrimeNumberInfoPageState extends State<PrimeNumberInfoPage> {
  ...
  void _onQuizPressed() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PrimeNumberPracticePage()),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberShowcase(
                      title: isEnglish
                          ? 'Prime number spotlight'
                          : 'Números primos destacados',
          ...
          Row(
            children: [
              const Icon(Icons.auto_awesome,
                  color: Color(0xFF4A148C), size: 30),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  title,
  ...
  Widget _buildNumberShowcase({
    ...
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF4A148C).withOpacity(0.92),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(
